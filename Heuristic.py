...
##                        print sitter_id, "FEAS",sitter_av[TW_start:TW_end]
        ...
        ##    c += 1
            ...
            return sitter_info, optimal_assignment,penalty_columns


if __name__ == '__main__':
    sitter_info = HeuristicSolver()
    sitter_info, optimal_assignment,penalty_columns = sitter_info.run()
